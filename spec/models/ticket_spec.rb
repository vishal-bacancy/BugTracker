...
RSpec.describe TicketsController, type: :controller do
  context 'test' do
    ...
    describe 'PUT update/:ticket.id ' do
      let(:attr) do
        { title: 'new title', description: 'new content', current_state: 'not null',
          current_release_milestone: 'any string', project_id: 'project id' }
      end
      ...
      it {
        @ticket.current_state.should eql attr [:current_state, %i[backlog open started pr_open to_be_tested closed]]
      }
    end
